    ...
    const convertToPercentage = () =>{
        if (firstNumber !== "" && operation !== "" && secondNumber !== "") {
            ...
            if(result !== null && typeof result === 'number'){
                setFirstNumber((result / 100).toString());
                setResult(null);
                setOperation("");
                setSecondNumber("")
            }
        ...
        <View style={Styles.viewBottom}>
            <View style={{height:120,width:"90%",justifyContent:"flex-end", alignSelf:"center"}}>
                <Text style={Styles.screenSecondNumber}>
                    {secondNumber}<Text style={{color:"grey", fontSize: 50, fontWeight:'500'}}>{operation}</Text>
                </Text>
                {firstNumberDisplay()}
            </View>
            ...
            <View style={Styles.row}>
                ...
                <Button title="%" onPress={() => convertToPercentage()}/>
            ...
            <View style={Styles.row}>
            <Button title="0" isZero onPress={() => handleNumberPress("0")}/>
